                ...
                <Card.Content>
                  ...
                  <View style={styles.goalsBreakdown}>
                    <View style={styles.goalsStat}>
                      ...
                      <Text
                        style={[styles.goalsStatValue, { color: "#4CAF50" }]}
                      >
                        {progress.achieved || 0}
                      </Text>
                    </View>
                    <View style={styles.goalsStat}>
                      ...
                      <Text
                        style={[styles.goalsStatValue, { color: "#FF9800" }]}
                      >
                        {progress.partial || 0}
                      </Text>
                    </View>
                    <View style={styles.goalsStat}>
                      ...
                      <Text
                        style={[styles.goalsStatValue, { color: "#F44336" }]}
                      >
                        {progress.not_achieved || 0}
                      </Text>
                    </View>
          ...
          <Card.Content>
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>
                Đánh giá được cập nhật định kỳ bởi giáo viên sau mỗi buổi học.
                Phụ huynh có thể theo dõi sự phát triển của bé qua từng mục
                tiêu.
              </Text>
            </View>
          </Card.Content>
