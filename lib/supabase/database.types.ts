...
export type Database = {
  ...
  public: {
    ...
    Views: {
      active_parent_permissions: {
        Row: {
          activated_at: string | null
          id: string | null
          invited_at: string | null
          parent_email: string | null
          parent_email_verified: string | null
    ...
    Functions: {
      ...
      is_parent_of_student: { Args: { student_uuid: string }; Returns: boolean }
      is_teacher_of_student: {
        Args: { student_uuid: string }
        Returns: boolean
      }
      parent_has_permission: {
        Args: { permission_key: string; student_uuid: string }
        Returns: boolean
      }
      restore_session: {
      ...
      update_all_parent_permissions: {
        Args: { p_parent_id: string; p_permissions: Json; p_student_id: string }
        Returns: boolean
      }
